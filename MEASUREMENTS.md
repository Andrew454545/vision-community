...
Scene embedding: **96 bytes**. Object embedding: **128 bytes**. Pose/pano
metadata: ~**80 bytes**. Ephemeral six-face working set: 4,608 bytes, discarded.
...
| --- | ---: | ---: |
| Community index + metadata at 20.96M | ~3.5 GiB | $0.00 |
| Community index + metadata at 200M | ~33 GiB | ~$0.34 |
| VISION-scale 3,080-byte embeddings at 20.96M | ~60 GiB | ~$0.75 |
| VISION-scale embeddings + metadata at 200M | ~590 GiB | ~$8.70 |
